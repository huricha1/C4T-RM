...
parser.add_argument("--PATH", type=str, default=os.path.expanduser('C4T-RM/EPIC/epic_interval60/'),
...
trainData = np.load(
    f'C4T-RM/EPIC/epic_interval60/epic_interval60_Train.npy',
    allow_pickle=False)
testData = np.load(
    f'C4T-RM/EPIC/epic_interval60/epic_interval60_Test.npy',
    allow_pickle=False)
valData = np.load(
    f'C4T-RM/EPIC/epic_interval60/epic_interval60_val.npy',
    allow_pickle=False)
test_ground_truth = np.load(
    f'C4T-RM/EPIC/epic_interval60/epic_interval60_test_ground_truth.npy',
    allow_pickle=False)
val_ground_truth = np.load(
    f'C4T-RM/EPIC/epic_interval60/epic_interval60_val_ground_truth.npy',
    allow_pickle=False)
