...
parser.add_argument("--PATH", type=str, default=os.path.expanduser('C4T-RM/SMD/smd_interval10/'),
...
trainData = np.load(
    f'C4T-RM/SMD/smd_interval10/smd_interval10_Train.npy',
    allow_pickle=False)
testData = np.load(
    f'C4T-RM/SMD/smd_interval10/smd_interval10_Test.npy',
    allow_pickle=False)
valData = np.load(
    f'C4T-RM/SMD/smd_interval10/smd_interval10_val.npy',
    allow_pickle=False)
test_ground_truth = np.load(
    f'C4T-RM/SMD/smd_interval10/smd_interval10_test_ground_truth.npy',
    allow_pickle=False)
val_ground_truth = np.load(
    f'C4T-RM/SMD/smd_interval10/smd_interval10_val_ground_truth.npy',
    allow_pickle=False)
